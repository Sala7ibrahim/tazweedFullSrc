...
this.uuidValue = this.Uuid.generateUUID();
  ...
  getAllCartProjects(){
    this.projectServ.getAllCartProjectsNew(localStorage.getItem("sessionUserType"), this.uuidValue, localStorage.getItem("auth"),localStorage.getItem("userId")).subscribe(
      (response: any) => {
